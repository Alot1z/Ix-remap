...
> **2026-09-05 draft-opens note (later same day):** with the owner's go, the two prepared train kits **opened as live drafts** — **#609** (installer README-fix, `feat/installer-readme-fix` @ `b77c4f52`) and **#610** (CONTRIBUTING draft-first note Refs #608, `docs/contributing-draft-first` @ `4caaf508`), both off main `e8ab1926`, draft-from-open with zero requested reviewers, contents built from the live `e8ab1926` text. All three train bodies (#605/#609/#610) are cross-linked. **What remains gated on your go at this item: the rebase of #605 onto `e8ab1926` and mark-ready of the trio together.** C3 stays held per its own kit.
